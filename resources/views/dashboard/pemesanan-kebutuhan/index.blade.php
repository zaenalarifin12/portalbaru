    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="card-footer" style="padding-top: 20px">
                <div class="row justify-content-between">
                    <p>Rp. {{ $item->harga }}</p>
                    <div>
                        <form action="{{ url("/pemesanan-kebutuhan/$item->id/cart") }}" method="post">
                            @csrf
                            <button type="submit" class="btn btn-sm btn-primary">Masukan ke keranjang</button>
                        </form>
                    </div>
                </div>
                <!-- /.row -->
        ...
        <div class="float-right">
          <a href="{{ url("/pesanan-saya") }}" class="btn btn-info btn-sm">Ke keranjang</a>
        </div>
